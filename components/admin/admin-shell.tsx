...
import { LayoutDashboard, LogOut, Menu, RefreshCw } from "lucide-react";

function AdminSidebar({ pathname }: { pathname: string }) {
  return (
    <aside className="bg-slate-950 text-slate-200 p-4 lg:p-5 border-r border-slate-800 h-full">
      <div className="mb-7">
          ...
          <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Sheet>
                <SheetTrigger asChild>
                  <button
                    type="button"
                    className="inline-flex lg:hidden items-center justify-center w-9 h-9 rounded-md border border-slate-300 text-slate-700 hover:bg-slate-100"
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium border border-slate-300 rounded-md hover:bg-slate-100"
              >
                <RefreshCw size={14} />
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-medium bg-slate-900 text-white rounded-md hover:bg-slate-800"
              >
                <LogOut size={14} />
